  ...
  return (
    <div className="client-project-container bg-black w-full h-auto">
      ...
      <div className="client-project-sections w-full h-auto flex flex-col items-center justify-center relative">
        ...
        <ProjectNavigation
          navColour={navigationMap.CrownBounce.navColour}
          navPreviousTitle={navigationMap.CrownBounce.previousTitle}
          navPreviousSrc={navigationMap.CrownBounce.previousSrc}
          navNextTitle={navigationMap.CrownBounce.nextTitle}
          navNextSrc={navigationMap.CrownBounce.nextSrc}
        />
      </div>
