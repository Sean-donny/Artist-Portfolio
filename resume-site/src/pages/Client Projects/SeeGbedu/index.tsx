    ...
    <div className="client-project-container bg-black w-full h-auto">
      ...
      <div className="client-project-sections w-full h-auto flex flex-col items-center justify-center relative">
        <main>
          ...
          <section className="client-project-deliverables-container h-auto w-full bg-[#c5a554] selection:bg-black selection:text-zinc-200 p-5">
        ...
        <ProjectNavigation
          navColour={navigationMap.SeeGbedu.navColour}
          navPreviousTitle={navigationMap.SeeGbedu.previousTitle}
          navPreviousSrc={navigationMap.SeeGbedu.previousSrc}
          navNextTitle={navigationMap.SeeGbedu.nextTitle}
          navNextSrc={navigationMap.SeeGbedu.nextSrc}
        />
      </div>
