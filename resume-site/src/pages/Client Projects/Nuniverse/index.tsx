  ...
  return (
    <div className="client-project-container bg-black w-full h-auto">
      ...
      <div className="client-project-sections w-full h-auto flex flex-col items-center justify-center relative">
        ...
        <ProjectNavigation
          navColour={navigationMap.Nuniverse.navColour}
          navPreviousTitle={navigationMap.Nuniverse.previousTitle}
          navPreviousSrc={navigationMap.Nuniverse.previousSrc}
          navNextTitle={navigationMap.Nuniverse.nextTitle}
          navNextSrc={navigationMap.Nuniverse.nextSrc}
        />
      </div>
