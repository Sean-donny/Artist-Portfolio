// Image imports
import yaSingleCover from '/optimised/smada_ye_anthem_cover_art.webp';
import yaYkRemix from '/optimised/smada_ye_anthem_yk_mule_remix.webp';
import yaSaRemix from '/optimised/smada_ye_anthem_sa_remix.webp';
import yaRoughSketch from '/optimised/smada_ye_anthem_sketch.webp';
import yaColouredRoughSketch from '/optimised/smada_ye_anthem_draft.webp';
import yaRefinedSketch from '/optimised/smada_ye_anthem_sketch_more_emotion.webp';
import yaBackgroundPainting from '/optimised/smada_ye_anthem_bg.webp';
...
const yeAnthemData = {
  SingleCover: {
    ...
    header: 'Single Cover',
    paragraph:
      "The primary cover captures Smada in sheer awe, shedding tears as he gazes at the backside of a charming girl in a bikini by the poolside. Behind him, King Perryy and Toyé are also captivated by the view. At this stage, feedback from the label was incorporated as they needed to meticulously curate the branding for their talent's debut single to meet their specific standards.",
  },
  YkRemix: {
    src: yaYkRemix,
    ...
    paragraph:
      'Different versions were crafted for the remixes to suit their respective releases. In this particular rendition, Smada is featured alongside DJ YK Mule.',
  },
  SaRemix: {
    src: yaSaRemix,
    ...
    paragraph:
      'This is the cover for the South-African remix by Mellow and Sleazy',
  },
  RoughSketch: {
    src: yaRoughSketch,
  ...
  ColouredRoughSketch: {
    ...
    paragraph:
      'Building upon the sketch, this illustration elaborated on the colour scheme, emphasizing a vibrant, lively, summer pool party aesthetic.',
  },
  RefinedSketch: {
    src: yaRefinedSketch,
