    ...
    <div className="client-project-container bg-black w-full h-auto">
      ...
      <div className="client-project-sections w-full h-auto flex flex-col items-center justify-center">
        ...
        >
          <motion.img
            src={yaBanner}
            alt="A sketch of Smada mesmerized by a gorgeous lday"
        ...
        <div className="client-project-design-goal-container h-auto w-full flex flex-col hd:flex-row p-5 hd:py-20 hd:px-5 selection:bg-rose-500 selection:text-zinc-200">
        ...
        <div className="client-project-references-container bg-rose-500 selection:bg-black selection:text-zinc-200 w-full h-auto flex flex-col items-center justify-center p-5 pt-10">
          <h4
          ...
          >
            <p className="client-project-reference-description-text w-full hd:w-3/5 m-auto font-custom text-2xl text-center text-black font-normal">
              ...
              So, I set the scene poolside, keeping the focus on the artists and
              what's blowing their minds. Managing projects like this comes with
              its challenges, especially making sure I capture the likeness of
              the subjects, as well as conveying their emotions accurately—like
              being utterly mesmerized by a gorgeous lady.
              <br />
              He sent in his photo reference, mainly to highlight his hairstyle.
              As for the two featured artists, I had to search for the right
              references for them. Crafting their illustrations presented its
              own puzzle, considering the need to respect their individual
              brands, especially when it's not their project, so they are not
              really in the feedback loop during visual development.
        ...
        <div className="client-project-sketches-container h-auto w-full flex flex-col hd:flex-row p-5 selection:bg-rose-500 selection:text-zinc-200">
          <div className="client-project-rough-sketch h-full w-full hd:w-1/2">
            <div className="client-project-rough-sketch-container flex flex-col items-center justify-center h-auto w-full p-5 hd:p-20 my-5 hd:my-0">
              <div className="client-project-rough-sketch-artwork h-3/5 w-full flex flex-col items-center justify-center">
                <motion.img
        ...
        <div className="client-project-process-container h-auto w-full flex flex-col hd:flex-row p-5 selection:bg-rose-500 selection:text-zinc-200">
        ...
        <div className="client-project-final-container h-auto w-full flex flex-col hd:flex-row p-5 selection:bg-rose-500 selection:text-zinc-200">
          <div className="client-project-single-cover h-full w-full hd:w-1/2 m-auto">
            <div className="client-project-single-cover-container flex flex-col items-center justify-center h-auto w-full p-5 hd:p-20 my-5 hd:my-0">
              <div className="client-project-single-cover-artwork h-3/5 w-full flex flex-col items-center justify-center">
                <motion.img
        ...
        <div className="client-project-remixes-container h-auto w-full flex flex-col hd:flex-row p-5 selection:bg-rose-500 selection:text-zinc-200">
          <div className="client-project-yk-remix h-full w-full hd:w-1/2">
            <div className="client-project-yk-remix-container flex flex-col items-center justify-center h-auto w-full p-5 hd:p-20 my-5 hd:my-0">
              <div className="client-project-yk-remix-artwork h-3/5 w-full flex flex-col items-center justify-center">
                <motion.img
          ...
          <div className="client-project-sa-remix h-full w-full hd:w-1/2">
            <div className="client-project-sa-remix-container flex flex-col items-center justify-center h-auto w-full p-5 hd:p-20 my-5 hd:my-0">
              <div className="client-project-sa-remix-artwork h-3/5 w-full flex flex-col items-center justify-center">
                <motion.img
        ...
        <div className="client-project-streaming-and-label-container w-full h-auto flex flex-col hd:flex-row items-center justify-center hd:py-20 selection:bg-rose-500">
          ...
          <div className="client-project-label-container h-auto w-full hd:w-1/2 p-5">
            <img
              src={yaNativeXDefJam}
        ...
        <div className="client-project-deliverables-container h-auto w-full bg-green-400 selection:bg-black selection:text-zinc-200 p-5">
