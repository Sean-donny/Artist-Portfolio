  ...
  return (
    <div className="personal-project-container bg-black w-full h-auto">
      ...
      <div className="personal-project-sections w-full h-auto flex flex-col items-center justify-center relative">
        ...
        <ProjectNavigation
          navColour={navigationMap.SubaruBoy.navColour}
          navPreviousTitle={navigationMap.SubaruBoy.previousTitle}
          navPreviousSrc={navigationMap.SubaruBoy.previousSrc}
          navNextTitle={navigationMap.SubaruBoy.nextTitle}
          navNextSrc={navigationMap.SubaruBoy.nextSrc}
        />
      </div>
    </div>
  );
