    ...
    <div className="client-project-container bg-black w-full h-auto">
      ...
      <div className="client-project-sections w-full h-auto flex flex-col items-center justify-center relative">
        <main>
          ...
          <article className="client-project-design-goal-container h-auto w-full flex flex-col hd:flex-row p-5 hd:py-20 hd:px-5 selection:bg-red-600 selection:text-zinc-200">
            <div className="client-project-design-goal-description-container h-auto w-full hd:w-3/5 hd:max-h-[1500px] xl:pl-20">
              ...
              <motion.p
                ...
                transition={{ delay: 0.3, ease: 'anticipate', duration: 1 }}
              >
                "Imagine me suspended in space, cradling the Earth in the palms
                of my hands"...
              </motion.p>
              <motion.p
          ...
          <article className="client-project-references-container bg-red-600 selection:bg-black selection:text-zinc-200 w-full h-auto flex flex-col items-center justify-center p-5 pt-10">
            <h2
              ...
              <article className="client-project-final-tracklist-container flex flex-col items-center justify-center h-auto w-full p-5 hd:p-20 my-5 hd:my-0">
                <figure className="client-project-final-tracklist-artwork h-3/5 w-full flex flex-col items-center justify-center">
                  <motion.img
                    ...
                    title={mkWrldData.TracklistCover.title}
                    loading="lazy"
                    className="mb-2"
                    ref={mikeAlbumTracklistCoverRef}
                    initial={{ opacity: 0 }}
          ...
          <section className="client-project-streaming-and-promotional-container w-full h-auto flex flex-col hd:flex-row items-center justify-center bg-zinc-900 hd:py-20 selection:bg-red-600">
        ...
        <ProjectNavigation
          navColour={navigationMap.MikesWrld.navColour}
          navPreviousTitle={navigationMap.MikesWrld.previousTitle}
          navPreviousSrc={navigationMap.MikesWrld.previousSrc}
          navNextTitle={navigationMap.MikesWrld.nextTitle}
          navNextSrc={navigationMap.MikesWrld.nextSrc}
        />
      </div>
