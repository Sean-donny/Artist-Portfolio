// Image imports
import pwSketchShortlist from '/optimised/popwave_draft_choices.webp';
import pwSketch from '/optimised/popwave_comic_sketch.webp';
import pwComicPanel from '/optimised/popwave_comic_panel.webp';
...
const popwaveData = {
  ...
  SketchedComicPanel: {
    ...
    paragraph:
      'Following the selection of option 3, a refined version was presented to the client for approval, which was subsequently followed by the creation of the final comic panel illustration.',
  },
  ComicPanel: {
    src: pwComicPanel,
    ...
    paragraph:
      "Both sides of the shirt are clearly sported by the characters, with the orange background capturing the high-octane scenario, which is also the brand's signature color.",
  },
};
