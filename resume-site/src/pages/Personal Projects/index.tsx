  ...
  const Projects = ({ personalProjectsData }: PersonalProjectsProps) => (
    <div className="personal-projects-content-images w-full h-full flex flex-wrap items-center justify-center">
      {Object.keys(personalProjectsData).map(key => {
        ...
        return (
          <motion.div
            className={`personal-projects-image-container h-auto p-2 flex flex-col items-center justify-center ${data.style} mb-10 hd:mb-2 cursor-pointer`}
          ...
          >
            <img
              ...
              title={data.title}
              loading="eager"
              className="personal-projects-image pointer-events-none w-auto h-auto"
              fetchPriority="high"
              width={1080}
              height={1080}
            />
