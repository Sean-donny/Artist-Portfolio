  ...
  return (
    <div className="client-project-container bg-black w-full h-auto">
      ...
      <div className="client-project-sections w-full h-auto flex flex-col items-center justify-center">
        ...
        <div className="client-project-design-goal-container h-auto w-full flex flex-col hd:flex-row p-5 hd:py-20 hd:px-5 selection:bg-rose-500 selection:text-zinc-200">
          <div className="client-project-design-goal-description-container h-auto w-full hd:w-3/5 hd:max-h-[1500px] xl:pl-20">
            ...
            <motion.p
              ...
              transition={{ delay: 0.3, ease: 'anticipate', duration: 1 }}
            >
              "I'd like you to work your magic and take the lead on this one; I
              trust your vision"
            </motion.p>
          </div>
        ...
        <div className="client-project-references-container bg-rose-500 selection:bg-black selection:text-zinc-200 w-full h-auto flex flex-col items-center justify-center p-5 pt-10">
          ...
          >
            <p className="client-project-reference-description-text w-full hd:w-3/5 m-auto font-custom text-2xl text-center text-black font-normal">
              Building upon the galactic themes introduced in the Family cover,
              I drew inspiration from the legendary{' '}
              <a
              ...
              characters as larger than life and backgrounds as tangible places,
              I incorporated these elements into my design approach. This
              influence guided the creation of a suit that encapsulated Smada's
            ...
            <div className="client-project-final-tracklist-container flex flex-col items-center justify-center h-auto w-full p-5 hd:p-20 my-5 hd:my-0">
              ...
              <div className="client-project-final-tracklist-description h-2/5 w-full flex flex-col items-center justify-center">
                ...
                <motion.p
                  ...
                  initial={{ opacity: 0 }}
                  animate={{
                    translateY: nuniverseFinalEpTracklistCoverParagraphPosition,
                    opacity: nuniverseFinalEpTracklistCoverParagraphOpacity,
                  }}
                >
        ...
        <div className="client-project-streaming-preview w-full h-auto p-5 hd:py-20 hd:px-0 flex flex-col items-center justify-center bg-zinc-900 selection:bg-rose-500">
          <iframe
            id="embedPlayer"
